...
for(const file of htmlFiles){
  ...
  const checks=[
    [/<!doctype html>/i,'doctype'],[/<html[^>]+lang="it"/i,'lang="it"'],[/name="viewport"/i,'viewport'],[/name="theme-color"/i,'theme-color'],[/class="skip-link"/i,'skip link'],[/<main\b/i,'main landmark'],[/assets\/css\/styles\.css\?v=v124-ux/i,'versioned stylesheet'],[/assets\/js\/ux-a11y\.js\?v=v124-ux/i,'UX accessibility runtime']
  ];
